...
import com.bluesgao.esdemo.entity.biz.TextSearch;
...
public class AutoCompleteController {
    ...
    public void index() throws IOException {
        ...
        GetRequest getIndexRequest = new GetRequest("auto_complete_index");
        boolean exists = client.exists(getIndexRequest, RequestOptions.DEFAULT);
        if (!exists) {
