package com.bluesgao.printtable;

import com.bluesgao.printtable.enums.Align;
import com.bluesgao.printtable.enums.NullPolicy;
import com.bluesgao.printtable.table.Body;
import com.bluesgao.printtable.table.Cell;
import com.bluesgao.printtable.table.Header;
import com.bluesgao.printtable.util.StringPadUtil;
...
public class PrintTable {
    ...
    public static class ConsoleTableBuilder {
        ...
        PrintTable consoleTable = new PrintTable();
    ...
    public static void main(String[] args) {
        ...
        //default
        new PrintTable.ConsoleTableBuilder().addHeaders(header).addRows(body).build().print();
